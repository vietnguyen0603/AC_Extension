...
namespace REX.Start
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            RunExtension(@"C:\Users\viet.nguyen\source\repos\AC_Extension\bin\Debug\AC_Extension.dll", "2016");
        }
        ...
        static void RunExtension(string FullPath, string VersionName)
        {
            ...
            if (applicationInstance.LoadExtension(FullPath, "REX.AC_Extension.Application"))
            {
